...
# Predefined test instances for predictions
test_instances = [
    {"Outlook": "Sunny", "Temperature": "Cool"},  # Expected: Yes
    {"Outlook": "Sunny", "Temperature": "Mild"},  # Expected: Yes
    {"Outlook": "Overcast", "Temperature": "Hot"},  # Expected: Yes
]
